        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
              About <span className="text-[#1456BC]">Data</span>
              <span className="text-[#FF8C42]">Sense</span>
            </h1>
            <p className="text-xl text-gray-700 leading-relaxed">
              We&apos;re building the future of IoT data visualization and
              analytics, helping businesses and individuals make sense of their
              data.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              At DataSense, we believe that data should be accessible and
              understandable to everyone. Our mission is to transform complex
              IoT data into clear, actionable insights through beautiful
              visualizations and powerful analytics tools.
            </p>
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              We&apos;re dedicated to helping our users monitor and optimize
              their IoT devices, whether they&apos;re managing smart home
              systems, industrial sensors, or environmental monitoring
              equipment.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-[#1456BC] to-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Ready to experience DataSense?
          </h2>
          <p className="text-xl mb-8 max-w-xl mx-auto">
            Join our growing community and start visualizing your data today.
          </p>
